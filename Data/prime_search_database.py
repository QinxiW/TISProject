...
def main():
    ...
    cols_to_keep = ['id', 'country_cleaned', 'description_cleaned_tokenized', 'sentiment', 'sentiment_score',
                    'designation_cleaned', 'points', 'price_imputated', 'province_leveled_cleaned', 'region', 'taster_name_cleaned',
